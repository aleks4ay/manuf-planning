...
<body>
    ...
    <h3><a href="/tmc">Общая таблица технологической продукции</a> </h3>
        ...
        <div>
            <table style="font-size: 14px; text-align: center; width: 59%;">
                <tr class="red" style="height: 1.8em; background: rgba(255, 209, 0, 0.56);">
        ...
        <div>
            <table style="font-size: 14px; text-align: center; width: 59%">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <a href="#top">Изменить </a> <%--/tmc/one/change/id--%>
                    </td>
                </tr>
                </c:forEach>
            </table>
        ...
        <div>
            <table style="font-size: 14px; text-align: center; width: 59%">
                <tr class="red" style="height: 2.8em; background: rgba(255, 209, 0, 0.56);">
    ...
    <div style="position: absolute; top: 20px; left: 62%;">
        <table align="right" style="font-size: 14px; text-align: center;">
            <tr class="red" style="height: 2.8em; background: rgba(100, 137, 255, 0.33);">
            ...
            <tr>
                <c:forEach var="manuf_date" items="${manuf1}" varStatus="pos">
                    <c:if test="${pos.first}">
                        <td colspan="5"> Выпущено ${manuf_date.timeManufacture} </td>
                    </c:if>
                </c:forEach>
            </tr>
