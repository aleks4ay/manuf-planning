...
public class Run {
    ...
    private static final String MAX_DEY_TO_SHIPMENT = "25-09-2020";
...
//    private Set<String> rangesIdOrder = new HashSet<>();
...
//        technoProducts.values().forEach(System.out::println);
...
//        Map<String, List<Invoice>> invoicesListMap = getInvoicesListMap(journalMap);
...
//        openOrderPointMap.values().forEach(System.out::println);
...
//            System.out.println(tmc.getDescr());
